...
(function (global) {
  ...
  const APP_BASE = 'https://daikou-app.vercel.app'; // メーター(ドライバーが使う)
  const OFFICE_BASE = 'https://daikome-jimusho.vercel.app'; // 事務所(社長が使う)
  ...
  const SEIKYU_BASE = 'https://daikou-seikyu.vercel.app';
